package com.zjy.phoenix.config.spring;
...
public class SpringContextHolder implements ApplicationContextAware, DisposableBean {
	 ...
	 * ApplicationContextRegister.getApplicationContext() .getBean("xxservice")
	 */
	...
	public void setApplicationContext(ApplicationContext applicationContext) {
		log.info("设置SpringContextHolder中的ApplicationContext:" + applicationContext);
